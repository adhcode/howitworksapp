...
const _businessvalidationservice = require("./business-validation.service");
...
describe('BusinessValidationService', ()=>{
    ...
    beforeEach(async ()=>{
        ...
        service = module.get(_businessvalidationservice.BusinessValidationService);
    });
    describe('validateContractCreation', ()=>{
        ...
        it('should throw error for past expiry date', ()=>{
            ...
            expect(()=>service.validateContractCreation(context)).toThrow(_invalidtransitiondateexception.InvalidTransitionDateError);
        });
    ...
    describe('validatePaymentProcessing', ()=>{
        ...
        it('should throw error for inactive contract', ()=>{
            ...
            expect(()=>service.validatePaymentProcessing(context)).toThrow(_invalidtransitiondateexception.InvalidTransitionDateError);
        });
    ...
    describe('validateEscrowRelease', ()=>{
        ...
        it('should throw error for already released escrow', ()=>{
            ...
            expect(()=>service.validateEscrowRelease(context)).toThrow(_escrowreleaseexception.EscrowReleaseError);
        });
    ...
    describe('validateTransitionDate', ()=>{
        ...
        it('should throw error for very close expiry date', ()=>{
            ...
            expect(()=>service.validateTransitionDate(veryCloseDate, 'yearly')).toThrow(_invalidtransitiondateexception.InvalidTransitionDateError);
        });
    });
});

//# sourceMappingURL=business-validation.service.spec.js.map