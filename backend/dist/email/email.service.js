...
let EmailService = class EmailService {
    initializeResend() {
        ...
        this.resend = new _resend.Resend(resendApiKey);
    }
    async sendVerificationEmail(email, firstName, token) {
        ...
        try {
            const { data, error } = await this.resend.emails.send({
                from: this.configService.get('RESEND_FROM_EMAIL', 'Property HomeCare <noreply@propertyhomecare.com.ng>'),
                to: [
                    email
                ],
          ...
          <head>
            ...
            <title>Verify Your Email - Property HomeCare</title>
          </head>
                    ...
                    <tr>
                      <td style="padding: 40px 30px;">
                        ...
                        <p style="color: #4b5563; line-height: 1.6; margin: 0 0 20px 0; font-size: 16px;">
                          Thank you for joining Property HomeCare! We're excited to have you on board.
                        </p>
                        ...
                        <div style="border-top: 1px solid #e5e7eb; padding-top: 20px;">
                          <p style="color: #9ca3af; font-size: 13px; line-height: 1.5; margin: 0;">
                            ...
                            If you didn't create an account with Property HomeCare, you can safely ignore this email.
                          </p>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style="background-color: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                        <p style="color: #6b7280; font-size: 13px; margin: 0 0 8px 0;">
                          © 2025 Property HomeCare. All rights reserved.
                        </p>
    ...
    async sendVerificationCodeEmail(email, firstName, code) {
        if (!this.resend) {
            this.logger.warn('Resend not configured. Skipping email send.');
            return;
        }
                      ...
                      <td style="padding: 40px 30px;">
                        ...
                        <div style="background-color: #f9fafb; border-left: 4px solid #1A2A52; padding: 16px; border-radius: 4px; margin: 0 0 30px 0;">
                          ...
                          <ol style="color: #6b7280; font-size: 13px; margin: 0; padding-left: 20px; line-height: 1.8;">
                            <li>Open the Property HomeCare app</li>
    ...
    async sendWelcomeEmail(email, firstName) {
        ...
        try {
            const { data, error } = await this.resend.emails.send({
                ...
                subject: 'Welcome to Property HomeCare! 🎉',
                html: `
          <!DOCTYPE html>
          <html>
          <head>
            <meta charset="utf-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <title>Welcome to Property HomeCare</title>
          </head>
          <body style="margin: 0; padding: 0; background-color: #f5f5f5; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
            <table role="presentation" style="width: 100%; border-collapse: collapse; background-color: #f5f5f5;">
              <tr>
                    ...
                    <tr>
                      <td style="padding: 40px 30px;">
                        ...
                        <h2 style="color: #1A2A52; margin: 0 0 20px 0; font-size: 24px; font-weight: 600; text-align: center;">
                          Welcome to Property HomeCare, ${firstName}!
                        </h2>
    ...
    async sendPaymentReminderEmail(email, firstName, title, message, amount, dueDate) {
        if (!this.resend) {
            this.logger.warn('Resend not configured. Skipping email send.');
            return;
        }
                        ...
                        <div style="background-color: #f9fafb; border-radius: 8px; padding: 24px; margin: 0 0 30px 0;">
                          <table role="presentation" style="width: 100%; border-collapse: collapse;">
                            ...
                            <tr>
                              ...
                              <td style="padding: 8px 0; color: #1A2A52; font-size: 16px; font-weight: 600; text-align: right;">${new Date(dueDate).toLocaleDateString('en-US', {
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric'
                })}</td>
    ...
    async sendPasswordResetEmail(email, firstName, token) {
        ...
        try {
            const { data, error } = await this.resend.emails.send({
                ...
                subject: 'Reset Your Password - Property HomeCare',
                html: `
          <!DOCTYPE html>
          <html>
          <head>
            <meta charset="utf-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <title>Reset Your Password - Property HomeCare</title>
          </head>
          <body style="margin: 0; padding: 0; background-color: #f5f5f5; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
            <table role="presentation" style="width: 100%; border-collapse: collapse; background-color: #f5f5f5;">
              <tr>
    ...
    async sendPasswordResetCodeEmail(email, firstName, code) {
        if (!this.resend) {
            this.logger.warn('Resend not configured. Skipping email send.');
            return;
        }
