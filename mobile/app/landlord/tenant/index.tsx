...
export default function TenantManagementScreen() {
      ...
      const propertiesWithTenants = await Promise.all(
        response.data.map(async (property) => {
          try {
            ...
            const tenantsResponse = await apiService.getTenantsByLandlord().catch(() => ({ data: [] }));
  ...
  const handleAddTenant = () => {
    router.push('/landlord/add-tenant');
  };
          ...
          <View style={styles.statsOverview}>
            ...
            <View style={styles.statsRow}>
              ...
              <View style={styles.statCard}>
                ...
                <Text style={styles.statValue}>{formatCurrency(totalStats.totalRent)}</Text>
